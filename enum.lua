...
AbilityIntegerLevelField = {
    ...
    RestoredMana_1ForCurrent = ConvertAbilityIntegerLevelField(0x69726333), --ABILITY_ILF_RESTORED_MANA__1_FOR_CURRENT
...
---@class OsKeyType
OsKeyType = {
    Backspace = ConvertOsKeyType(0x8), --OSKEY_BACKSPACE
    Tab = ConvertOsKeyType(0x9), --OSKEY_TAB
    Clear = ConvertOsKeyType(0xc), --OSKEY_CLEAR
    Return = ConvertOsKeyType(0xd), --OSKEY_RETURN
...
UnitWeaponBooleanField = {
    _ShowUi = ConvertUnitWeaponBooleanField(0x75777531), --UNIT_WEAPON_BF_ATTACK_SHOW_UI
    SEnabled = ConvertUnitWeaponBooleanField(0x7561656e), --UNIT_WEAPON_BF_ATTACKS_ENABLED
    _ProjectileHomingEnabled = ConvertUnitWeaponBooleanField(0x756d6831), --UNIT_WEAPON_BF_ATTACK_PROJECTILE_HOMING_ENABLED
}
...
UnitWeaponStringField = {
    T = ConvertUnitWeaponStringField(0x7561316d), --UNIT_WEAPON_SF_ATTACK_PROJECTILE_ART
}
